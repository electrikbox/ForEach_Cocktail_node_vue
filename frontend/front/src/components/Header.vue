    ...
    <nav class="navbar navbar-expand-lg navbar-light mb-4">
      <div class="container">
        <ul class="navbar-nav flex-row justify-content-center w-100">
          <li v-if="token" class="nav-item mx-2"><RouterLink class="btn btn-link colo" to="/home">User List</RouterLink></li>
          <li v-if="token" class="nav-item mx-2"><RouterLink class="btn btn-link" to="/cocktails">Cocktails List</RouterLink></li>
          <li v-if="token" class="nav-item mx-2"><RouterLink class="btn btn-link" to="/addCocktail">Add Cocktail</RouterLink></li>
